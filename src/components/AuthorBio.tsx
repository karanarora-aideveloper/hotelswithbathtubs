...
export default function AuthorBio() {
  return (
    <div className="bg-gradient-to-br from-gray-50 via-white to-amber-50/40 border border-gray-200 rounded-3xl p-6 sm:p-8 mt-12 mb-8 shadow-xs">
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
        <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-tr from-accent-secondary to-accent text-white flex items-center justify-center font-heading text-2xl sm:text-3xl font-extrabold shadow-md flex-shrink-0">
          KA
        </div>
        <div className="flex-1">
          ...
          <div className="flex items-center gap-4 text-xs font-semibold text-accent-secondary">
            ...
            <span>&bull;</span>
            <a href="mailto:editorial@hotelswithbathtubs.com" className="hover:text-accent underline transition-colors">
