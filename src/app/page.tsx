...
export const metadata = {
  ...
  description: 'Find 1,160+ verified hotels with private bathtubs in room, jacuzzi suites & deep soaking tubs across 41 countries. Triple-checked on Booking.com & Agoda.',
  alternates: {
    canonical: '/',
    languages: {
          ...
          <header className="relative pt-32 pb-44 px-4 sm:px-8 text-center bg-accent-secondary hero-overlay overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-white">
              ...
              <p className="text-lg sm:text-xl md:text-2xl font-medium drop-shadow-md mb-8 opacity-90 max-w-3xl mx-auto">
                1,160+ curated hotels with bathtub in room across 41 countries — every listing triple-verified across Booking.com &amp; Agoda. No misleading photos. Guaranteed private tubs.
              </p>
            </div>
          </header>
