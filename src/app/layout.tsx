...
export const metadata: Metadata = {
  ...
  description: "Discover 1,630+ verified hotels with private in-room bathtubs and jacuzzis across 170+ destinations in 64 countries. Triple-verified across Booking.com & Agoda for romantic getaways.",
  alternates: {
    canonical: 'https://www.hotelswithbathtubs.com',
  },
  openGraph: {
    title: "Hotels with Bathtubs & Jacuzzi Suites | Verified Stays",
    description: "Discover 1,630+ verified hotels with private in-room bathtubs and jacuzzis across 170+ destinations in 64 countries. Triple-verified on Booking.com & Agoda.",
