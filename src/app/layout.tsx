...
export const metadata: Metadata = {
  ...
  description: "Discover 1,550+ verified hotels with private in-room bathtubs and jacuzzis across 165+ destinations in 59 countries. Triple-verified across Booking.com & Agoda for romantic getaways.",
  alternates: {
