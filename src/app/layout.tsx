...
export const metadata: Metadata = {
  ...
  description: "Discover 1,220+ verified hotels with private in-room bathtubs and jacuzzis across 145+ destinations in 46 countries. Triple-verified across Booking.com & Agoda for romantic getaways.",
  alternates: {
    canonical: 'https://www.hotelswithbathtubs.com',
  },
  openGraph: {
    title: "Hotels with Bathtubs & Jacuzzi Suites | Verified Stays",
    description: "Discover 1,220+ verified hotels with private in-room bathtubs and jacuzzis across 145+ destinations in 46 countries. Triple-verified on Booking.com & Agoda.",
